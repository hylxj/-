	...
	<div class="layui-col-md9 layui-col-xs12" >
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input busPlate" lay-verify="required" placeholder="请输入车辆车牌号">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input incomeTime" id="incomeTime" lay-verify="time" placeholder="请输入车辆收入结算时间">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input incomeCash" lay-verify="number" placeholder="请输入现金收入">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input incomeOnline" lay-verify="number" placeholder="请输入线上收入">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input incomeCard" lay-verify="number" placeholder="请输入刷卡收入">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input incomedayTotal" lay-verify="number" placeholder="请输入每日总额">
					</div>
				</div>
			...
			<div class="layui-right">
				...
				<a class="layui-btn layui-btn-sm"  id = 'close'><i class="layui-icon">&#xe61c;</i>返回</a>
			</div>
		</div>
	</div>
	</div>
