			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input busPlate" lay-verify="busPlate" style="width: 300px" placeholder="">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">服役时间</label>
					<div class="layui-input-block">
						<input type="text" class="layui-input busCreateTime" lay-verify="newsName" style="width: 300px" placeholder="">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">公交车名称</label>
					<div class="layui-input-block">
						<input type="text" class="layui-input busName" lay-verify="busName" style="width: 300px" placeholder="">
					</div>
				</div>
				<div class="layui-form-item magt3">
