			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input buscenName" lay-verify="required" placeholder="请输入总站名称">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input buscenDistrict" lay-verify="required" placeholder="请输入总站所属区">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input buscenManagerid" lay-verify="number" placeholder="请输入总站负责人编号">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input buscenCreatetime" id="expenseTime" lay-verify="time" placeholder="请选择总站创建时间">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input buscenStatus" lay-verify="number" placeholder="请输入总站状态">
					</div>
				</div>
