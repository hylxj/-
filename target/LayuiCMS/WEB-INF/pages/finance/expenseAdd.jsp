			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseSalary" lay-verify="number" placeholder="请输入员工工资">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseFix" lay-verify="number" placeholder="请输入车辆维修费用">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseDaily" lay-verify="number" placeholder="请输入日常支出金额">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseTime" id="expenseTime" lay-verify="time" placeholder="请输入支出时间">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseStaId" lay-verify="required" placeholder="请输入支出站点">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expenseHendler" lay-verify="required" placeholder="请输入经手人">
					</div>
				</div>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input expanseTotal" lay-verify="number" placeholder="请输入支出总额">
					</div>
				</div>
