...
<form class="layui-form layui-row">
    ...
    <div class="layui-col-md6 layui-col-xs12">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="${user.type == 1 ? "超级用户": "普通用户"}" disabled
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="tel" value="${user.phone}" placeholder="请输入手机号码" lay-verify="phone"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="<fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd" />"
                       placeholder="请输入出生年月" lay-verify="birthday" readonly class="layui-input birthday">
            </div>
        </div>
